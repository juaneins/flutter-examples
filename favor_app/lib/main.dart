...
import 'package:favor_app/favor.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
import 'package:favor_app/friend.dart';
import 'package:favor_app/mock_values.dart';
      ...
      children: <Widget>[
        ...
        Expanded(
          child: Padding(
            ...
            child: Text("${favor.friend.name} asked to you ..."),
          ),
        ),
      ],
    );
